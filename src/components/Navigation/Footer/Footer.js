    ...
    <footer id="footer">
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="logo_footer dark col-md-3">
            ...
            <p className="block">
              <a href="https://maps.google.com/?q=5220+Judsonville+Dr.+Antioch,%C2%A0+94531&entry=gmail&source=g" target="_blank" rel="noopener noreferrer">5220 Judsonville Dr.<br />Antioch, CA 94531</a><br />
            ...
            <p className="block">
              <a href="https://www.facebook.com/ChateauJudsonville1" target="_blank" className="social fa fa-facebook" rel="noopener noreferrer"></a>
          ...
          {/* col #2 */}
          <div className="spaced col-md-offset-3 col-sm-4 col-md-3">
      ...
      <div className="copyright">
        <div className="container text-center fsize12">
          Web Development by <a href="https://duaneleem.com" target="_blank" title="React Programming" className="copyright" rel="noopener noreferrer">LeemTek</a> &bull; All Right Reserved &copy; Chateau Judsonville.
        </div>
      </div>
    </footer>
  );
